        ...
        @forelse ($wishlists as $key => $wishlist)
            @if ($wishlist->product != null)
                <div class="col-xxl-3 col-xl-4 col-lg-3 col-md-4 col-sm-6" style="background-color: #1D4C58;" id="wishlist_{{ $wishlist->id }}">
                    <div class="card mb-2 shadow-sm" style="background-color: #1D4C58;border-color: #40A6BF !important;">
                        <div class="card-body" style="background-color: #1D4C58;border-color: #40A6BF !important;">
        ...
        @empty
            <div class="col">
                <div class="text-center bg-white p-4 rounded shadow">
                    ...
                    <h5 class="mb-0 h5 mt-3" style="color: #FFFFFF;" >{{ translate("There isn't anything added yet")}}</h5>
                </div>
            </div>
        @endforelse
    </div>
