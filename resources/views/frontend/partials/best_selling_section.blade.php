            ...
            <div class="px-2 py-4 px-md-4 py-md-3 shadow-sm rounded" style="background-color: #1D4C58;">
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class=" border-primary border-width-2 pb-3 d-inline-block" style="color: #FFFFFF;">{{ translate('Best Selling') }}</span>
                    </h3>
                    <a href="javascript:void(0)" class="ml-auto mr-0 btn btn-primary btn-sm shadow-md" style="color: #1D4C58;">{{ translate('Top 20') }}</a>
                </div>
