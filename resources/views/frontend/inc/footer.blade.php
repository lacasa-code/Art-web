<section class="bg-white border-top mt-auto" style="background-color: #1D4C58;">
    <div class="container">
        <div class="row no-gutters" style="background-color: #1D4C58;">
                ...
                <div class="mt-4">
                    ...
                    <div class="d-inline-block d-md-block mb-4">
                        <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}">
                            ...
                            <button type="submit" class="btn btn-primary" style="color: #1D4C58;border:#40A6BF solid; margin-left:10px">
                                {{ translate('Subscribe') }}
                            </button>
                        </form>
                    </div>
