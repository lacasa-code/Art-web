                ...
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                    ...
                    <li class="list-inline-item dropdown mr-3" id="lang-change">
                        ...
                        <a href="javascript:void(0)" class="dropdown-toggle text-reset py-2" data-toggle="dropdown" data-display="static">
                            ...
                            <span class="opacity-60" style="color:#FFFFFF;">{{ \App\Models\Language::where('code', $locale)->first()->name }}</span>
                        </a>
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm" style="background-color: #1D4C58;">
    <div class="position-relative logo-bar-area z-1" style="background-color: #1D4C58;">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-80px h-md-80px" height="80">
                        @else
                            <img src="{{ static_asset('assets/img/dark.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40">
                        @endif
                    </a>
                ...
                <div class="d-none d-lg-block  align-self-stretch ml-3 mr-0" data-hover="dropdown">
                    <div class="nav-cart-box dropdown h-100" id="cart_items" style="color: #FFFFFF;">
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="border-top border-gray-200 py-1" style="background-color: #1D4C58;">
            <div class="container" style="background-color: #1D4C58;">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    @foreach (json_decode( get_setting('header_menu_labels'), true) as $key => $value)
                    <li class="list-inline-item mr-0" style="color: #FFFFFF;">
                        <a href="{{ json_decode( get_setting('header_menu_links'), true)[$key] }}"  style="color: #FFFFFF;" class="opacity-60 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            {{ translate($value) }}
                        </a>
                    </li>
                    @endforeach
